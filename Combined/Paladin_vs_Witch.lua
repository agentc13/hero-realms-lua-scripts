...
-- player 1 plays as paladin, player 2 plays as witch
...
function setupGame(g)
    ...
    standardSetup(g, {
        description = "Paladin vs Witch game. Witch created by Userkaffe, Paladin created by agentc13.",
...
function setupMeta(meta)
    meta.name = "Paladin_vs_Witch"
    meta.minLevel = 0
    meta.maxLevel = 0
    meta.introbackground = ""
    meta.introheader = ""
    meta.introdescription = ""
    meta.path = "Z:/Downloads/Paladin_vs_Witch.lua"
     meta.features = {
}
