				...
				createCardEffectAbility(
					{
						...
						effect = createCardEffect(jigmelingpa_carddef(), currentSkillsLoc).seq(sacrificeTarget().apply(selectSource())).seq(
							gainHealthEffect(4)
						)
					}
				)
...
-- Need to get Ally Faction abilites working and forpat card text properly.
